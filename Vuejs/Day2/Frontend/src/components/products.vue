<template>
  <div class="container bootstrap snippets bootdeys">
    <div class="row">
      <div class="col-md-4 col-sm-6 content-card" v-for="product in data" :key="product.id">
        <div class="card-big-shadow">
          <div class="card card-just-text" data-background="color" data-color="blue" data-radius="none">
            <div class="content">
              ...
              <div>
                <router-link :to="`/products/${product.id}/update`" class="btn btn-dark">Update</router-link>
                <button class="btn btn-danger ms-2" @click="deleteProduct(product.id)">Delete</button>
              </div>
            </div>
          </div>
        </div>
